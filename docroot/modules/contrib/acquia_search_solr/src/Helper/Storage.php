...
class Storage {
  ...
  public static function getApiHost() {
    return \Drupal::config('acquia_search_solr.settings')->get('api_host') ?? 'https://api.sr.acquia.com';
  }
  ...
  public static function getVersion(): string {
    ...
    if (!$version = \Drupal::state()->get('acquia_search_solr.version')) {
      $info = system_get_info('module', 'acquia_search_solr');
   ...
   *
   * @see \Drupal\acquia_search_solr\Plugin\SolrConnector\SearchApiSolrAcquiaSearchSolr::getExtractQuery()
   */
