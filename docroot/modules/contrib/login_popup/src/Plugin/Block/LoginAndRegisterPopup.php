...
//    $url_register = 'new-member';
    ...
    if (\Drupal::currentUser()->isAnonymous()) {
      $build['login_register_popup_block']['#markup'] = '<div class="Login-Register-popup-link"><span>' . $link_login . '</span>  <span class="btn-signup"><a class="btn btn-sm btn-primary active" href="new-member">Sign up</a></span> </div>';
    }
