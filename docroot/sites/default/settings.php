 ...
 * @endcode
 */
$settings['hash_salt'] = 'WY7qpDNRYs-2plEgNE-I4-BMUiMQqdZUPVOSFg62xIP-YSBcwmkHk1zRfvbfacziSRG00v-usA';
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/breedbookslive/breedbookslive-settings.inc');
}
